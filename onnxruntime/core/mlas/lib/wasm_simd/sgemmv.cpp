...
--*/
{
    ...
    for (; CountK >= 4; CountK -= 4) {
        ...
        for(; N >= kWide; N -= kWide) {
            ...
            // MLAS_FLOAT32X4 vec_c2 = MlasMultiplyAddFloat32x4(A0, MlasLoadFloat32x4(b + 8), MlasLoadFloat32x4(c + 8));
            // MLAS_FLOAT32X4 vec_c3 = MlasMultiplyAddFloat32x4(A0, MlasLoadFloat32x4(b + 12), MlasLoadFloat32x4(c + 12));
            ...
            // vec_c2 = MlasMultiplyAddFloat32x4(A1, MlasLoadFloat32x4(b + ldb + 8), vec_c2);
            // vec_c3 = MlasMultiplyAddFloat32x4(A1, MlasLoadFloat32x4(b + ldb + 12), vec_c3);
            ...
            // vec_c2 = MlasMultiplyAddFloat32x4(A2, MlasLoadFloat32x4(b2 + 8), vec_c2);
            // vec_c3 = MlasMultiplyAddFloat32x4(A2, MlasLoadFloat32x4(b2 + 12), vec_c3);
            ...
            // vec_c2 = MlasMultiplyAddFloat32x4(A3, MlasLoadFloat32x4(b2 + ldb + 8), vec_c2);
            // vec_c3 = MlasMultiplyAddFloat32x4(A3, MlasLoadFloat32x4(b2 + ldb + 12), vec_c3);

            MlasStoreFloat32x4(c, vec_c0);
            MlasStoreFloat32x4(c + 4, vec_c1);
            // MlasStoreFloat32x4(c + 8, vec_c2);
            // MlasStoreFloat32x4(c + 12, vec_c3);
